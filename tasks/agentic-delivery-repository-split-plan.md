...
| Pull-request observation path | `.github/workflows/agent-observation.yml`, `scripts/validate-observation-event.mjs`, draft30 release with draft23 bootstrap | Read-only observation; no lifecycle write-back or model execution |
...
| Distribution/bootstrap | `agentic-delivery-distribution`, draft16 bundle, 7/7 tests | Opt-in fixture and PR projection; no consumer enrollment |
...
has no fallback for either identity. Current draft controller `0.2.0-draft.30`
is pinned to `069475071cfa6b725446e8179ad1db164dc2d96e`; draft29 at
`7061773305054da9eb33b4ef872a7b7c63364d65` remains the explicit rollback
...
The current controller draft `0.2.0-draft.30` pins Architecture draft
