...
- Branch from the current `main`; keep the branch's pull-request head separate from `main`, which is the protected base. Never open a pull request with `main` as its head.
