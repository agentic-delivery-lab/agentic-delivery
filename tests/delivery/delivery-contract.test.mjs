...
test('delivery tooling uses pnpm and portable ESM entry points', async () => {
  for (const relativePath of [
    ...
    'config/github-app-contract.json', 'config/primitive-selection.yml', 'schemas/github-app-contract.v1.schema.json', 'schemas/primitive-selection.v1.schema.json', 'scripts/validate-github-app-contract.mjs',
  ...
  assert.equal(release.version, '0.2.0-draft.29');
  assert.equal(release.commit, '7061773305054da9eb33b4ef872a7b7c63364d65');
