...
test('repository decision and runner contracts are present', async () => {
  ...
  for (const record of ['0013-derive-adr-traceability-from-agentic-primitives.md', '0014-use-a-repository-scoped-github-app.md', '0015-isolate-resumable-runner-execution.md', '0016-require-structured-pull-request-descriptions.md']) {
